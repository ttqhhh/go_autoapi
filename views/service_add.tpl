        ...
        window.initForm = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#service_name").val(serviceData.service_name)
                    var business = serviceData.business
                    $("#business").find("option[value="+business+"]").prop("selected",true);
                    form.render();
                }
            });
        }
...
<div>
    <form id="service" class="layui-form" method="post" action="/service/save">
        ...
        <div class="layui-form-item" style="width: 350px">
            ...
            <div class="layui-input-block">
                <input type="text" id="service_name" name="service_name" required  lay-verify="required" placeholder="请输入服务名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item" style="width: 350px">
            <label class="layui-form-label">业务线</label>
            <div class="layui-input-block">
                <select id="business" name="business" lay-verify="required">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn layui-btn-normal" onclick="addService()">保存</button>
                <button class="layui-btn layui-btn-normal" onclick="cancelLayer()">取消</button>
            </div>
        </div>
    </form>
</div>
