...
func (t *CaseSetMongo) GetCaseSetByPage(page, limit int, business_code string, caseSetName string, caseSetId int, author string) (result []CaseSetMongo, totalCount int64, err error) {
